...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>ef', ':NvimTreeFindFile<CR>', { desc = 'Find current file in tree', silent = true })
    vim.keymap.set('n', '<leader>ec', ':NvimTreeCollapse<CR>', { desc = 'Collapse all folders', silent = true })
